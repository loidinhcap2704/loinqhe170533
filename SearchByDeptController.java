 ...
 * @author sonnt
 */
public class SearchByDeptController extends BaseRequiredAuthenticationController {
    ...
    throws ServletException, IOException {
        ...
        String[] dids_raw = request.getParameterValues("did");
        if(dids_raw != null)
        {
            ArrayList<Integer> dids = new ArrayList<>();
            for (String did : dids_raw) {
                dids.add(Integer.parseInt(did));
            }
            StudentDBContext dbStu = new StudentDBContext();
            ArrayList<Student> students = dbStu.search(dids);
